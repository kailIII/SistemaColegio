Public Class frmEstadoCuenta
  ...
  'Private Sub dgvObligaciones_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvObligaciones.SelectionChanged
  '  Dim ob As Obligacion

  '  If dgvObligaciones.CurrentRow IsNot Nothing AndAlso DirectCast(dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuenta).Obligacion IsNot Nothing Then
  '    ob = DirectCast(dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuenta).Obligacion
  '    If ob.Codigo > 0 Then
  '      btnAnular.Enabled = True
  '      If ob.Vigencia = True Then
  '        btnAnular.Text = "An&ular"
  '      Else
  '        btnAnular.Text = "Acti&var"
  '      End If
  '    Else
  ...
  Private Sub btnBeneficios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBeneficios.Click
    Dim frm As frmGestionBeneficioAlumno

    If Me.Persona IsNot Nothing Then
      frm = New frmGestionBeneficioAlumno
      frm.Presentar(DirectCast(Persona, Alumno))
      frm = Nothing
  ...
  Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
    Dim frm As frmModificarObligacion

    If Me.dgvObligaciones.CurrentRow IsNot Nothing Then
      frm = New frmModificarObligacion
      frm.Presentar(DirectCast(Me.dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuentaSeleccionar).Obligacion)
      frm = Nothing
  ...
  Private Sub btnAsociarPago_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAsociarPago.Click
    Dim f As frmAsociarPago

    If Me.dgvObligaciones.CurrentRow IsNot Nothing Then
      f = New frmAsociarPago

      f.AsociarPago(Me.Persona, Me.txtSeccion.Text, DirectCast(Me.dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuentaSeleccionar))
      f = Nothing
      Me.MostrarEstadoCuenta(Me.Persona)
    End If
  End Sub

  Private Sub btnCambiarAlumno_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCambiarAlumno.Click
    Dim frm As frmReasignarObligacion

    If Me.dgvObligaciones.CurrentRow IsNot Nothing AndAlso _
       DirectCast(Me.dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuentaSeleccionar).Obligacion IsNot Nothing Then
      frm = New frmReasignarObligacion
      frm.Reasignar(modPrincipal.mOAnioActual, Me.Persona, DirectCast(Me.dgvObligaciones.CurrentRow.DataBoundItem, DetalleEstadoCuentaSeleccionar).Obligacion)
      frm.Dispose()
      frm = Nothing
      Me.MostrarEstadoCuenta(Me.Persona)
    End If
