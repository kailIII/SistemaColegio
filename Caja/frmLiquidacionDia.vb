...
Public Class frmLiquidacionDia
  ...
  Private Sub btnRegistrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistrar.Click
    Dim rn As New RNLiquidacion

    Try
      rn.Registrar(New Liquidacion With {.Numero = CInt(Me.nudNumero.Value), _
                                         .Fecha = Me.dtpFecha.Value, _
                                         .Entidad = Me.cboEntidad.Text.Substring(0, 1)})
