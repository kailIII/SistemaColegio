...
Public Class rptListaDeudores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colegio.Caja.rptListaDeudores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaDeudores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaDeudores = New rptListaDeudores
        rpt.Site = Me.Site
        Return rpt
    End Function
