...
#End Region
  ...
  Private Sub mostrarDatos(ByVal wAlumno As Alumno)
    ...
    If wAlumno IsNot Nothing Then
      obj = New RNAlumno
      wAlumno = obj.Leer(New Alumno(wAlumno.Codigo))
      obj = Nothing
      If wAlumno IsNot Nothing Then
        Alum = wAlumno
        Codigo = Alum.Codigo
        ...
        End If
        dtpfechaN.Value = Alum.FechaNacimiento
        CLugarNac.cbopais.Text = Alum.LugarNacimiento.Pais
        CLugarNac.cbodpto.Text = Alum.LugarNacimiento.Departamento
        CLugarNac.cbopPvcia.Text = Alum.LugarNacimiento.Provincia
        CLugarNac.cbodistrito.Text = Alum.LugarNacimiento.Distrito

        txtemail.Text = Alum.Email
        txtdireccion.Text = Alum.Direccion
        txttelefono.Text = Alum.Telefono
      ...
      Else
        MessageBox.Show("No se encontró información del alumno solicitado", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
      End If
    End If
