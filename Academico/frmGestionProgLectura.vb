Public Class frmGestionProgLectura
  ...
  '            For Each P In lpl
  '                If CType(Me.dgvAlumnos.Rows(i).DataBoundItem, Matricula).NroMatricula = P.Matricula.NroMatricula Then
  '                    dgvAlumnos.Rows(i).Cells("cdAgregar").Value = True
  ...
  Private Sub btnRegistrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistrar.Click
    Dim rnProg As RNProgramacionLectura = Nothing
    ...
    Try
      rnProg = New RNProgramacionLectura
      If VerificarLibroPresentacion() > 0 Then
        If VerificarSeleccion() > 0 Then
          For a As Integer = 0 To dgvAlumnos.RowCount - 1
            ...
            list = rnProg.VerificarExistencia(CInt(Me.dgvAlumnos.Rows(a).Cells("cdCodigoPL").Value))
            ...
            If estado Then
              ...
              If list.Count > 0 Then
                ...
                rnProg.Actualizar(New ProgramacionLectura(codProgLect, "P", True, NroGrupo, codPres, New Libro(codLibro), Matricula, _
                    New Seccion(sec.Grado.Codigo, moAnioActual.anio, sec.Letra)))

              Else
                'No existe
                rnProg.Registrar(New ProgramacionLectura(0, "P", True, NroGrupo, codPres, New Libro(codLibro), Matricula, _
                                    New Seccion(sec.Grado.Codigo, moAnioActual.anio, sec.Letra)))
            ...
            Else
              ...
              If list.Count > 0 Then
                ...
                'Eliminar!!!!
                For Each X In list
                  rnProg.Eliminar(New ProgramacionLectura(X.Codigo))
                Next
              End If
            End If
          Next
  ...
  End Function
  'Private Sub dgvGrupoLibro_EditingControlShowing(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles dgvGrupoLibro.EditingControlShowing
  '    Dim combo As ComboBox = CType(e.Control, ComboBox)

  '    ' If Not TypeOf e.Control Is DataGridViewComboBoxEditingControl Then Return

  '    If combo IsNot Nothing Then
  '        RemoveHandler combo.SelectedValueChanged, New EventHandler(AddressOf dgGrupoLibro_SelectedValueChanged)
  '        AddHandler combo.SelectedValueChanged, New EventHandler(AddressOf dgGrupoLibro_SelectedValueChanged)
  '    End If

  'End Sub
  'Private Sub dgGrupoLibro_SelectedValueChanged(ByVal sender As Object, ByVal e As EventArgs)
  '    Dim combo As ComboBox = DirectCast(sender, ComboBox)

  '    If combo.SelectedIndex > -1 Then
  '        codigoLibro = CType(combo.SelectedItem, GradoLibro).Libro.Codigo
  '    End If
  'End Sub
  ...
  Private Sub btnAlumnos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlumnos.Click
    ...
    If Me.dgvGrupoLibro.Rows(Me.dgvGrupoLibro.Rows.IndexOf(Me.dgvGrupoLibro.CurrentRow)).Cells("cdImg").Value IsNot Nothing Then
      Seleccionar()
    Else
      txtTotal.Text = "0"
    End If
