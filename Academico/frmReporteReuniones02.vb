...
Public Class frmReporteReuniones02
  ...
  Private Sub frmReporteReuniones02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If objMat.ListarMatriculas(CType(cboAnio.SelectedItem, AnioLectivo)) > 0 Then
      ...
      Try
        ...
        If sw = 1 And cboNivel.SelectedIndex > -1 Then
          Me.pbAvance.Value = 5
          Libro = excel.Workbooks.Add(AppDomain.CurrentDomain.BaseDirectory & "\Plantillas\reuniones2.xls")
              ...
              If NroSec > 0 Then
                ...
                For Each S In objSec
                  ...
                  If S.Grado.codigoNivel = nivel.Codigo Then
                    ...
                    Hoja.Range("C2").Value = CType(cboAnio.SelectedItem, AnioLectivo).anio
                    tutor = objRNSec.NombreTutor(S, CStr(cboAnio.SelectedValue))
                    Hoja.Range("C4").Value = tutor
                    Hoja.Range("C5").Value = nivel.Nombre & S.NivelNumeroLetra
