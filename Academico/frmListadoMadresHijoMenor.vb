...
Public Class frmListadoMadresHijoMenor
  Implements iReporte

  Private Const CELDAINICIO As String = "B8"

  Private Madres As List(Of Pariente)
  ...
  Private Sub btnListar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnListar.Click
    ...
    Me.Madres = rn.ListarMadresHijoMenor(moAnioActual)
    dgvApoderados.AutoGenerateColumns = False
    dgvApoderados.DataSource = Me.Madres
  ...
  Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
    If Me.Madres IsNot Nothing Then
      Me.ExportarReporte()
    End If
  End Sub
  ...
  Private Sub ExportarReporte()
    ...
    Try
      ...
      If Me.Madres IsNot Nothing AndAlso Me.Madres.Count > 0 Then
        Me.mDialogoGuardar.Filter = "Archivos (*.xls)|*.xls"
        Me.mDialogoGuardar.FileName = "Listado de madres"

        m_excel = CrearExcel()
        Libro = AbrirPlantilla(m_excel, Me.mDialogoGuardar, AppDomain.CurrentDomain.BaseDirectory & "\Plantillas\ListadoMadres.xls")
        If Libro IsNot Nothing Then
          Hoja = DirectCast(Libro.Worksheets.Item("Datos"), Worksheet)

          Hoja.Range("B5").Value = "Listado de madres"
          Hoja.Range("C6").Value = DateAndTime.Now.ToShortDateString

          Me.ExportarDatos(Hoja.Range(CELDAINICIO).Offset(1, 0))

          Hoja.Range(Hoja.Range(CELDAINICIO).Offset(1, 0), Hoja.Range(CELDAINICIO).Offset(Me.Madres.Count, 7)).EntireColumn.AutoFit()
          BordesTodo(Hoja.Range(Hoja.Range(CELDAINICIO).Offset(1, 0), Hoja.Range(CELDAINICIO).Offset(Me.Madres.Count, 7)))
