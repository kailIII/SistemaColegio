...
Public Class frmReporteIngresoCalificacionesPrimaria
  Implements iReporte
  ...
  Private moNivel As New Nivel(2, "PRIMARIA", "P")
  ...
  Private Sub btnListar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnListar.Click
    ...
    If cboPeriodo.SelectedIndex > -1 Then
      ...
      dt = rn.ListarAvanceRegistroNotasPrimaria(moNivel, DirectCast(cboPeriodo.SelectedItem, PeriodoAcademico))
      rn = Nothing

      dt.Columns.Add("Docente", GetType(String), "ApellidoPat + ' ' + ApellidoMat + ' ' + Nombre")
      dt.Columns.Add("Seccion", GetType(String), "Numero + ' - ' + Letra")
      dt.Columns.Add("IndicadoresRegistrados", GetType(String), "IIF( Indicadores IS NOT NULL, Indicadores, 'SIN REGISTRAR')")
      dt.Columns.Add("CalificacionesEsperadas", GetType(Integer), "Alumnos * Indicadores + 2 * Alumnos")
      dt.Columns.Add("CalificacionesRegistradas", GetType(Integer), "IIF( (Letras + Promedios + Esfuerzos ) IS NOT NULL , (Letras + Promedios + Esfuerzos ), 0 )")
      dt.Columns.Add("CalificacionesFaltantes", GetType(Integer), "CalificacionesEsperadas - CalificacionesRegistradas")
  ...
  Private Sub ExportarDatos(ByVal dt As System.Data.DataTable)
    ...
    Try
      ...
      Libro = m_excel.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory & "\Plantillas\Avance registro de notas Primaria.xls")
      ...
      If dt.Rows.Count > 0 Then
        ...
        For Each dr As DataRow In dt.Rows
          ...
          celda.Offset(0, 3).Value = dr.Item("Alumnos").ToString
          celda.Offset(0, 4).Value = dr.Item("IndicadoresRegistrados").ToString
          celda.Offset(0, 5).Value = dr.Item("CalificacionesEsperadas").ToString
          celda.Offset(0, 6).Value = dr.Item("CalificacionesRegistradas").ToString
          celda.Offset(0, 7).Value = dr.Item("CalificacionesFaltantes").ToString
