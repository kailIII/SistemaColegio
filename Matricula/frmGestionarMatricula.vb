...
Public Class frmGestionarMatricula
  ...
  Private Sub Buscar()
    ...
    If auxal.Codigo <> 0 Then
      ...
      If matAct Is Nothing Then
        ...
        Me.txtAlumno.Text = alu.NombreCompleto
        Me.LlenarDatosApoderado(alu.Codigo)
        ...
        If mat IsNot Nothing Then
          ...
          Me.apod = DirectCast(Me.cboApoderado.SelectedItem, Parentesco)
          sw = 1
        Else
          If Me.cboApoderado.Items.Count > 0 Then
            apod = CType(Me.cboApoderado.SelectedItem, Parentesco)
          Else
            apod = Nothing
          End If
      ...
      Else
        If MessageBox.Show("El alumno ya ha sido matriculado" & vbNewLine & _
          ...
          End Select
          LlenarDatosApoderado(alu.Codigo)
  ...
  Public Sub LlenarDatosApoderado(ByVal codigo As Integer)
    ...
    cboApoderado.ValueMember = "CodigoApoderado"
      ...
      Try
        If Me.txtAlumno.Text <> "" And Me.cboApoderado.Text <> "" Then
          ...
          If Me.codigoEstado = 0 Then
            objGra = New RNGrado
            mat = New Matricula(DateAndTime.Now, sec.Grado, alu, _
                                New Personal(mOUsuario.Persona.Codigo), _
                                sec.Anio, sec.Letra, True, 0, 0, 0, 0, alu, _
                                apod, "IN")
            mat.TipoMatricula = CodigoTipoMatricula()

            objMat.Registrar(mat, apod)
            MessageBox.Show("La matrícula se registró exitosamente", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
          Else
            apod = CType(Me.cboApoderado.SelectedItem, Parentesco)
            mat = New Matricula(matModif.Numero, DateAndTime.Now, sec.Grado, alu, New Personal(mOUsuario.Persona.Codigo), sec.Anio, sec.Letra, True, CDbl(0), CInt(0), CInt(0), CInt(0), alu, apod)
  ...
  Private Sub Matriculados()
    ...
    If objMat.ListarMatriculas(moAnioActual) > 0 Then
      ...
      If Mat IsNot Nothing Then
        ...
        Me.codigoEstado = 1
      Else
        MessageBox.Show("Matrícula anulada o se canceló la selección", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
      End If
    Else
  ...
  Private Sub btnNuevoAlu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevoAlu.Click
    ...
    If A IsNot Nothing Then
      ...
      Me.alu = A
      If Me.cboApoderado.Items.Count > 0 Then
        Me.apod = CType(Me.cboApoderado.SelectedItem, Parentesco)
      Else
        Me.apod = Nothing
      End If
      Me.btnNuevoApo.Enabled = True
