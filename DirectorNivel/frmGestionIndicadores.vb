    ...
    If Me.ValidateChildren Then
      Try
        ...
        If codigo = 0 Then
          ...
          MessageBox.Show("Criterio registrado con éxito ", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
          Obj.Actualizar(New Indicador(codigo, txtNombre.Text, CheckVigencia.Checked, mOPeriodoActual.Codigo, dc.Codigo, NRO))
          MessageBox.Show("Criterio Actualizado con éxito ", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
