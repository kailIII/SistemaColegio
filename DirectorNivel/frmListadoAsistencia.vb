...
Public Class frmListadoAsistencia
  ...
  Private Sub btnListar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnListar.Click
    ...
    If Me.cboSeccion.SelectedIndex > -1 And (fechaIni <= fechaFin) Then
      rn = New RNSeccion
      dt = rn.ListarAsistenciaxSeccion(modPrincipal.moNivel, DirectCast(cboSeccion.SelectedItem, Seccion),
                                       modPrincipal.mOPeriodoActual, fechaIni, fechaFin,
                                       Me.cboTipoRegistro.SelectedValue.ToString)
  ...
  Private Sub PresentarSecciones()
    ...
    ListSec = objS.Leer_NivelAcad(moAnioActual, moNivel, 1, True)
    ...
    Try
      ...
      If Me.dt IsNot Nothing AndAlso Me.dt.Rows.Count > 0 Then
        ...
        If Libro IsNot Nothing Then
          ...
          Hoja.Range("B5").Value = "Listado de asistencia - " & moAnioActual.Anio & "-" & _
          moNivel.Nombre & "-" & cboSeccion.Text
