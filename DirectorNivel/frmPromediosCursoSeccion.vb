...
Public Class frmPromediosCursoSeccion
  ...
  Private Sub btnListar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnListar.Click
    ...
    If cboSeccion.SelectedIndex > -1 Then
      rn = New RNSeccion
      dt = rn.ListarPromedioCurso(DirectCast(cboSeccion.SelectedItem, Seccion))
  ...
  Private Sub ExportarDatos(ByVal dt As System.Data.DataTable)
    ...
    Try
      ...
      Me.sfdArchivos.FileName = "Reporte de promedios por Curso - " & moAnioActual.anio.Trim & "_" & cboSeccion.Text & ".xls"
      If Me.sfdArchivos.ShowDialog = System.Windows.Forms.DialogResult.Cancel Then
        Return
      End If

      Libro = m_excel.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory & "\Plantillas\Promedios de curso por seccion.xls")
      ...
      Hoja.Range("B5").Value = "Reporte de promedios por curso - " & moNivel.Nombre & " " & moAnioActual.anio & "-" & moNivel.Nombre
