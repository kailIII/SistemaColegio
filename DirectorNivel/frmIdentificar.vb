Public Class frmIdentificar
  ...
  Private Function Validar(ByVal wUser As Usuario) As Boolean
    ...
    o = rnU.VerificarDirectorNivel(wUser)

    If o IsNot Nothing Then
      mOUsuario = o
      moNivel = rnU.ObtenerNivel(wUser)
      Me.Close()
    Else
      MessageBox.Show("El Usuario debe ser Director(a) de Nivel!!!", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
    End If
  End Function

  Private Sub frmIdentificar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    'Me.txtUsuario.Text = "etorres"
