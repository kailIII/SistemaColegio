Public Class frmIdentificar
  ...
  Private Function Validar(ByVal wUser As Usuario) As Boolean
    ...
    o = rnU.VerificarCoorPlanLectorTutor(wUser)

    If o IsNot Nothing Then
      mOUsuario = o
      Me.Close()
    Else
      MessageBox.Show("El Usuario debe ser Coordinador(a) del Plan Lector!!!", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
