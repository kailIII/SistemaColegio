...
Module modExcel
  ...
  Public Function AbrirLibro(ByVal wExcel As Application, ByVal wDialogo As OpenFileDialog) As Workbook
    Dim wb As Workbook = Nothing

    If wDialogo.ShowDialog = System.Windows.Forms.DialogResult.Cancel Then
      Return Nothing
    End If
    wb = wExcel.Workbooks.Open(wDialogo.FileName)
  ...
  Public Sub CeldaFondo(ByVal wCelda As Range, ByVal wColor As Integer)
    With wCelda
      With .Interior
        .Pattern = XlPattern.xlPatternSolid
        .PatternColorIndex = XlPattern.xlPatternAutomatic
